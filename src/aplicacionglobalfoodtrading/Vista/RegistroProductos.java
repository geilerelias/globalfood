...
public class RegistroProductos extends javax.swing.JFrame {
    ...
    public void CargarForm(Producto p) {
        ...
        txtBodega.setText(p.getFk_bodega());
        txtCategoriaform.setText(p.getFk_categoria());
        txtSubCategoria.setText(p.getFk_subcategoria());
        ...
        txtProveedor.setText(p.getFk_proveedor());
    ...
    private void initComponents() {
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 16), new java.awt.Color(204, 0, 153))); // NOI18N
    ...
    private void txtCostoproductoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCostoproductoKeyTyped
        ...
        if (Character.isLetter(c)) {
            ...
            try {
                ...
                this.txtCostoEnUss.setText(String.valueOf(totalUs));
            } catch (java.lang.NumberFormatException ex) {
...
//          }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtCodigo.getText().isEmpty() || txtBodega.getText().isEmpty() || txtCategoriaform.getText().isEmpty() || txtSubCategoria.getText().isEmpty()
            ...
            p.setFk_proveedor(txtProveedor.getText());
            p.setPrec_cost_prod(Float.parseFloat(txtCostoproducto.getText()));
            p.setPrec_cost_prod_dolar(Float.parseFloat(txtCostoEnUss.getText()));
