...
import aplicacionglobalfoodtrading.Controlador.Controlador_Giro_Negocio;
 ...
 */
public class Giro_Negocio_Proveedor extends javax.swing.JFrame {
    Controlador_Giro_Negocio cgn = new Controlador_Giro_Negocio();
    DefaultTableModel modelo = new DefaultTableModel();
    public Giro_Negocio_Proveedor() {
        initComponents();
        this.setTitle("Giro de Negocio");
        CrearTabla();
        CargarTabla();
    }

    public void CargarForm(Giro_Negocio g){
        this.txtDescripcion.setText(g.getDescripcion());
    }
    ...
    public void LimpiarTabla() {
        int filas = TablaGiro.getRowCount();
    ...
    public void CargarTabla(){
        ArrayList<Giro_Negocio> lg = new ArrayList();
        lg = cgn.ListadoGiro();
        LimpiarTabla();
        for(Giro_Negocio g : lg){
            String datos[] ={g.getDescripcion()};
            modelo.addRow(datos);
        } 
    }
    ...
    private void initComponents() {
        ...
        jMenuItem4.setText("Seleccionar Giro de negocio");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Información de Giro de negocio", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 16))); // NOI18N
        ...
        TablaGiro.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        TablaGiro.setComponentPopupMenu(jPopupMenu1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtDescripcion.getText().isEmpty()) {
            ...
            int ex = cgn.RegistrarGiro_Negocio(g);

            if (ex == 0) {
                JOptionPane.showMessageDialog(null, "Error al Giro negocio");
            } else {
                LimpiarForm();
                CargarTabla();
                JOptionPane.showMessageDialog(null, "Giro de negocio se registro correctamente!!!!");
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (txtDescripcion.getText().isEmpty()) {
            ...
            Giro_Negocio gn = new Giro_Negocio();
            gn = cgn.GiroxCodigo(txtDescripcion.getText());
            int ex = cgn.EliminarGiro(gn);
            if (ex == 0) {
                JOptionPane.showMessageDialog(null, "No se encontro el giro a eliminarr");
            } else {
                LimpiarForm();
                CargarTabla();
                JOptionPane.showMessageDialog(null, "Giro de negocio Eliminado");
            }
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        if(TablaGiro.getSelectedRow()<0){
            JOptionPane.showMessageDialog(null,"No se ha seleccionado ninguna fila");
        }else{ 
            int f = TablaGiro.getSelectedRow();
            String texto = modelo.getValueAt(f,0).toString();
           RegistroProveedores.txtGiroNeg.setText(texto);
        }
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        if(TablaGiro.getSelectedRow()<0){
            ...
            int f = TablaGiro.getSelectedRow();
            String texto = modelo.getValueAt(f,0).toString();
            this.txtDescripcion.setText(texto);
        }
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        if(TablaGiro.getSelectedRow()<0){
            ...
            String texto = modelo.getValueAt(f,0).toString();
            this.txtDescripcion.setText(texto);
            Giro_Negocio g = cgn.GiroxCodigo(texto);
            cgn.EliminarGiro(g);
            CargarTabla();
            JOptionPane.showMessageDialog(null,"Giro Eliminado Correctamente !!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Giro_Negocio_Proveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Giro_Negocio_Proveedor().setVisible(true);
            }
        });
    }
