...
//                 }
            ...
            for (Producto p : lp) {
                String datos[] = {p.getCod_prod(), p.getNombre_prod(), p.getFk_proveedor(), String.valueOf(p.getPrec_cost_prod()) ,String.valueOf(p.getPrec_vent_prod()), String.valueOf(p.getUtilidad_prod()), p.getTipo_prod(), String.valueOf(p.getPrecio_neto_prod()),String.valueOf(p.getPrecio_mas_impuesto())};
                modelo.addRow(datos);
            }
    ...
    private void initComponents() {
        ...
        CboOpcion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Codigo", "Nombre", "Proveedor", "Tipo" }));
